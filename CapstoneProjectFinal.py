...
import random
while True:
  choice_1 = st.text_input("Would you like to guess a number generated by the computer?: Yes to guess against the computer or No to make the computer guess your number: ", key = 'cdef')
  if choice_1 == 'No':
